...
def re_captcha_post(page, bot_id, tweet_type):
    ...
    action_chain=[
                ...
                {"action":"move_and_type", "target_role":None,"target_name":None, "css_selector":"#new-post-button", "xpath":"/html/body/div[2]/div/main/div[2]/form/p/textarea", "text":new_post_content},
